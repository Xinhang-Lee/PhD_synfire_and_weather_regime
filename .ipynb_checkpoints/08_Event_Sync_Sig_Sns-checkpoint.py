'''
calculate the number of synchronous event between region pairs for the real time series and the permutation ensemble.
'''
...
def SynEvent_Rand(time_series_rand, tau_max):
    ...
    '''
    calculate event synchronicity (ES). 
