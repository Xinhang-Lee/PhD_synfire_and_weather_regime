...
# load time series
time_series_rand_ens = pd.read_csv(f"/net/rain/hyclimm/data/projects/SynFire/WP1/Create_Permutation_Ensemble_wo_2001_2002/fire_time_series_Bpermutation_2000_{season}_wo_2001_2002.csv")
...
def Parallel_EventSyn_Rand(tau_max):
    ...
    results.to_csv(f"/net/rain/hyclimm/data/projects/SynFire/WP1/Event_Sync_Sig_Sns_wo_2001_2002/{fire}/Sigtest/ES_Bpermutation_2000_taumax_{tau_max}_{season}_wo_2001_2002.csv", index = False)
...
#cut 2001-2002
fire_time_series = fire_time_series[fire_time_series['Time'].dt.year >= 2003].reset_index(drop = True)
...
def SynEvent(time_series, tau_max):
    ...
    #save
    ES_matrix.to_csv(f"/net/rain/hyclimm/data/projects/SynFire/WP1/Event_Sync_Sig_Sns_wo_2001_2002/{fire}/Snstest/ES_matrix_taumax_{tau_max}_{season}_wo_2001_2002.csv", index = True)
